...
namespace Arbitra.Background.MatchFinders
{
    internal class TipsportMatchFinder : IMatchFinder
    {
        ...
        public TipsportMatchFinder()
        {
            ...
            matchElementPath = By.CssSelector(".t-background");
            namesElementPath = By.CssSelector(".hcZOGh");
            oddsElementPath = By.CssSelector(".iIqoeg");
            referenceLinkElementPath = By.CssSelector("a");
            timeElementPath = By.CssSelector(".hIGnAi");
            oddClassName = "sc-568228cd-12 bjvuxo";
        ...
        public ListOfMatches FindAllMatches(string geckoDriverDirectory, ChromeOptions options, TimeSpan commandTimeOut)
        {
            ...
            using (var driver = new ChromeDriver(geckoDriverDirectory, options))
            {
