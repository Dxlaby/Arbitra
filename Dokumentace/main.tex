...
\textbf{Odds} - list objektů Odd, který uchovává všechny možné kurzy na jeden konkrétní výsledek zápasu. Obsahuje metodu Sort(), která seřadí kurzy od největšího po nejmenší.
...
V konzoli se mohou vypsat errory ohledně nedostupného requestu. Ty pouze informují uživatele o faktu, že se kód snažil získat požadavek, který neexistuje. Nejčastěji z důvodu, že se nějaká hodnota chybně označila za např. ID turnaje, zápasu apod. Díky tomu se snažil kód získat request, který neexistuje. Nejedná se ovšem o chybu, která by naznačovala nefunkční systém. Pouze poukazuje, že kód na extrahování dat není naprogramován důkladně.
